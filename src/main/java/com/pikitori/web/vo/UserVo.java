...
public class UserVo {
	...
	private Long user_social_index;
	...
	public Long getUser_social_index() {
		return user_social_index;
	}
	public void setUser_social_index(Long user_social_index) {
	...
	public String toString() {
		return "UserVo [user_no=" + user_no + ", user_id=" + user_id + ", user_password=" + user_password
				+ ", user_name=" + user_name + ", user_reg_date=" + user_reg_date + ", user_role=" + user_role
				+ ", user_status=" + user_status + ", user_profile_url=" + user_profile_url + ", user_profile_msg="
				+ user_profile_msg + ", user_post_count=" + user_post_count + ", user_follower_count="
				+ user_follower_count + ", user_following_count=" + user_following_count + ", user_social_index="
				+ user_social_index + ", user_social_id=" + user_social_id + "]";
	}
